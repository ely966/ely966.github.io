...
@Component({
  selector: 'app-notificaradmin',
  templateUrl: './notificaradmin.component.html',
  styles: [
  ]
})
export class NotificaradminComponent implements OnInit {

  mailto="mailto:som...@example.com?Subject=Hello%20again"
  comprobar:any;
  submitted = false;
  loading = false;
